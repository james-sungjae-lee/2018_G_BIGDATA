...
idx2char = ['t', 'e', 'm', 'p', 'l','a']
# Teach hello: hihappy  -->  ihappy
x_data = [[0, 1, 2, 3, 4, 5,]]   # hihappy
x_one_hot = [[[1, 0, 0, 0, 0, 0],   # t 0
              [0, 1, 0, 0, 0, 0],   # e 1
              [1, 0, 1, 0, 0, 0],   # m 2
              [0, 0, 0, 1, 0, 0],   # p 3
              [0, 0, 0, 0, 1, 0],   # l 4
...
y_data = [[1, 2, 3, 4, 5, 0, 1]]    # emplate

num_classes = 6
input_dim = 6  # one-hot size
hidden_size = 6  # output from the LSTM. 5 to directly predict one-hot
batch_size = 1   # one sentence
sequence_length = 7  # |ihello| == 6
learning_rate = 0.1
...
#cell 만들고(BasicLSTMCell),  초기화 후 output 생성(dynamic_rnn)
